...
public class RightZigzagTetronimo extends Tetronimo{
    public RightZigzagTetronimo(Cell centerCell, Array<Cell> boardCells) {
        super(centerCell, boardCells, TetrisConstants.RIGHT_ZIGZAG_TETRONIMO_COLOR);
    }
