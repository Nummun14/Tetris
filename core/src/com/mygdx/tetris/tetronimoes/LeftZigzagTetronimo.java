...
public class LeftZigzagTetronimo extends Tetronimo{
    public LeftZigzagTetronimo(Cell centerCell, Array<Cell> boardCells) {
        super(centerCell, boardCells, TetrisConstants.LEFT_ZIGZAG_TETRONIMO_COLOR);
    }
